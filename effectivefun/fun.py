...
def main(robotIP, PORT=9559):
    ...
    tts.say("^start(animations/Stand/Gestures/Enthusiastic_4) First you t. The menu is eggs, bacon, pancakes, and orange juice. I wish I could eat that! ^stop(animations/Stand/Gestures/Enthusiastic_4)")
    ...
    tts.say("^start(animations/Stand/Gestures/Explain_8) Next is play time and you can choose to go to the game room, or the library. Why do ghosts like to visit the library? They go through the books very quickly! ^start(animations/Stand/Gestures/Explain_8)")
    tts.say("After that is Lunch. The menu is Mac n cheese, apple sauce, and milk. Tasty!")
    tts.say("^start(animations/Stand/Gestures/Enthusiastic_5) Next it will be time to do your schoolwork. What is a pirates favorite letter? Arrr! ^start(animations/Stand/Gestures/Enthusiastic_5)")
    ...
    tts.say("^start(animations/Stand/Gestures/Hey_6) Finally after that it is bedtime. Goodnight! Dont let the bed bugs bite! If they do, hit them with a shoe, until theyre black and blue! ^stop(animations/Stand/Gestures/Hey_6)")
